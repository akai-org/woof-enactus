"use client";
import { Box, Card, Container, Flex, Grid, Heading } from "@chakra-ui/react";
...
export default function AboutUsPage() {
  useEffect(() => {
    document.body.style.backgroundImage = "url('/aboutus-bg.svg')";
      ...
      <Card.Root>
        ...
        <Card.Body>
          <Card.Description>
            ...
            elementum, faucibus leo eu, volutpat lorem. Cras consequat ligula ut
            blandit accumsan. Quisque pulvinar placerat neque, non fermentum
            nisl finibus a. Nunc rhoncus consectetur lectus. Praesent at orci
            dictum, egestas tortor sed, consequat ipsum. Sed eget leo nec metus
            blandit ultricies. Curabitur ut tellus lacus. Morbi lectus arcu,
            condimentum in volutpat vel, dictum quis libero. Sed quis lorem
            rhoncus, lobortis massa et, pellentesque risus. Curabitur dapibus
            tellus eget sem commodo semper. Aenean ultricies nibh ipsum, quis
            ultrices justo lacinia non. Sed dignissim tortor ac sapien volutpat
            pretium. Donec tincidunt mauris risus, id interdum nulla consectetur
            eget. Curabitur sit amet massa nec justo tempus dignissim sed id
            lacus. Proin dignissim mi in nisi mollis, in imperdiet dui viverra.
            Integer tristique porttitor tristique. Nulla nec commodo turpis.
            Mauris vitae dictum est. Aenean a felis ac velit condimentum
            vestibulum id nec magna. Ut et velit id erat finibus porttitor at id
            sem. Sed vulputate tempor ex eget molestie. Etiam nibh ligula,
            blandit ornare magna laoreet, iaculis laoreet eros. Aliquam tempor
            ...
            ligula. Nam turpis enim, consequat eu ligula quis, suscipit lobortis
            magna. Praesent aliquam, elit a placerat mattis, diam magna
            pellentesque mauris, id faucibus leo purus sed augue. Phasellus
            semper, urna vitae mollis cursus, elit turpis vehicula arcu, nec
            maximus ex massa et ante. Sed vulputate risus a viverra tempor. Sed
            accumsan finibus pulvinar.
          </Card.Description>
        </Card.Body>
      </Card.Root>
      <Card.Root
      ...
      >
        ...
        <Card.Body>
          <Card.Description color="brand.700" fontWeight="semibold">
            Odwiedź nasz profil na platformie Instagram lub Facebook @woof_put!
